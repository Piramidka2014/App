...
bot = telebot.TeleBot('2027158573:AAGAXRoiVU34b0Ga4ppU1tQ0GltfldWub2Q')
...
def start(message):
	...
	send_message = f"<b>Привет {message.from_user.first_name}!</b>\nХотите узнать данные про коронавируса напишите " \
		f"название страны, например: сша,украiна, россия и так далее\n"
